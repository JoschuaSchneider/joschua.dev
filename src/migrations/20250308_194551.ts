...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_photos_camera" AS ENUM('pentax_k1000', 'fujifilm_x100vi');
  ...
  CREATE INDEX IF NOT EXISTS "photos_image_idx" ON "photos" USING btree ("image_id");
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_photos_camera";`);
}
